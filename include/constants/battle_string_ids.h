...
enum StringID
{
    ...
    STRINGID_PKMNCANTUSEMOVEPANIC,
    STRINGID_PKMNGOTPANIC,
    STRINGID_PKMNSITEMHEALEDPANIC,
    STRINGID_ATTACKERHEALEDITSPANIC,
    STRINGID_PKMNPANICHEALED,
    STRINGID_PKMNPANICHEALED2,
    STRINGID_PKMNPANICHEALEDBY,
