...
const struct NatureInfo gNaturesInfo[NUM_NATURES] =
{
    ...
    [NATURE_QUIET] =
    {
        .name = COMPOUND_STRING("Thoughtful"),
        .statUp = STAT_SPATK,
        .statDown = STAT_SPEED,
        .backAnim = 2,
    ...
    [NATURE_SASSY] =
    {
        .name = COMPOUND_STRING("Forgetful"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_SPEED,
        .backAnim = 1,
